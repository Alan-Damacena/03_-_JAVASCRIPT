//Criando uma classe de erro personalizado herdando da classe Error
...
try {
    ...
    if (!nome || idade == null || profissao == null) {
        ...
        //criando um novo objeto da classe ErroFormulario, passando uma mensagem personalziada
